...
<style>
 ...
 <body>
  ...
  <details>
    ...
    <p> <h4>ЗАКРОЙ А ТО еще стыдно я только учусь но все будет гуд ,я верю и ты в меня поверь человек который это читает ))solod_3310</h4> </p> 
  </details>
  <details> 
  <summary>Мысли в Слух!</summary> 
  <p><h4>А что же еще можно было бы добавить в этот список и как сделать так что бы было написано что то другое кроми <mark>"Подробнее"</mark> </h4></p> 
  </details>
 ...
 <audio src="Halib.mp3.mp3"  controls="controls" preload="auto" poster="pfoto.jpg"></audio>
  ...
  <article>
    ...
    <p> <time>07/04/2020 </time>
      ...
      Был добавлен выпадающий список с возможность поиска по вводу символов</p>
